...
CREATE OR REPLACE PROCEDURE simple_ior (
 ...
 BEGIN
    ...
    FROM results_ior ior1
      ...
      ORDER BY ior1.daos_commit, oclass_sort(ior1.oclass), server_client_sort(ior1.num_servers, ior1.num_clients);
  END //
DELIMITER ;
...
CREATE OR REPLACE PROCEDURE compare_ior (
 ...
 BEGIN
    ...
    FROM results_ior ior1 JOIN results_ior ior2
      ...
      ORDER BY ior1.daos_commit, ior2.daos_commit, oclass_sort(ior1.oclass), oclass_sort(ior2.oclass), server_client_sort(ior1.num_servers, ior1.num_clients);
  END //
DELIMITER ;
...
CREATE OR REPLACE PROCEDURE compare_ior_s_ec (
 ...
 BEGIN
    ...
    FROM results_ior ec_ior JOIN results_ior s_ior
      ...
      ORDER BY ec_ior.daos_commit, oclass_sort(ec_ior.oclass), server_client_sort(ec_ior.num_servers, ec_ior.num_clients);
  END //
DELIMITER ;
...
CREATE OR REPLACE PROCEDURE compare_mdtest_s_ec (
 ...
 BEGIN
    ...
    FROM results_mdtest ec_mdt JOIN results_mdtest s_mdt
      ...
      ORDER BY ec_mdt.daos_commit, oclass_sort(ec_mdt.oclass), server_client_sort(ec_mdt.num_servers, ec_mdt.num_clients);
  END //
DELIMITER ;
...
CREATE OR REPLACE PROCEDURE simple_mdtest (
 ...
 BEGIN
    ...
    FROM results_mdtest mdtest1
      ...
      ORDER BY mdtest1.daos_commit, oclass_sort(mdtest1.oclass), server_client_sort(mdtest1.num_servers, mdtest1.num_clients);
  END //
DELIMITER ;
...
CREATE OR REPLACE PROCEDURE compare_mdtest (
 ...
 BEGIN
    ...
    FROM results_mdtest mdtest1 JOIN results_mdtest mdtest2
      ...
      ORDER BY mdtest1.daos_commit, mdtest2.daos_commit, oclass_sort(mdtest1.oclass), oclass_sort(mdtest2.oclass), server_client_sort(mdtest1.num_servers, mdtest1.num_clients);
  END //
DELIMITER ;
