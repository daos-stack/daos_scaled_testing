...
env['DAOS_DIR']    = abspath(expandvars("${WORK}/BUILDS/TAGS/v2.3.102-tb_fake/latest/daos")) # Path to daos
env['DST_DIR']     = abspath(expandvars("../")) # Path to daos_scaled_testing repo
env['RES_DIR']     = abspath(expandvars("${WORK}/RESULTS/sanity")) # Path to test results
