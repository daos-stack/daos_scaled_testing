...
env['DAOS_DIR']    = abspath(expandvars("${WORK}/BUILDS/master/latest/daos")) # Path to daos
env['DST_DIR']     = abspath(expandvars("../")) # Path to daos_scaled_testing repo
env['RES_DIR']     = abspath(expandvars("${WORK}/RESULTS/weekly/2022-02-24")) # Path to test results
