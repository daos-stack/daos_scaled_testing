...
def main(args):
    ...
    if 'basic' in reports:
        ...
        calls += [
            ...
            ['mdtest_hard_c16_S1.csv',      'compare_mdtest_c16',  ['mdtest_hard%', 'S1', 'S1', args.base_commit, args.commit]],

            ['ior_easy_1to4_RP_2GX.csv',    'compare_ior_1to4',    ['ior_easy%', 'RP_2GX', 'RP_2GX', args.base_commit, args.commit]],
            ['ior_easy_c16_RP_2GX.csv',     'compare_ior_c16',     ['ior_easy%', 'RP_2GX', 'RP_2GX', args.base_commit, args.commit]],
            ['ior_hard_1to4_RP_2GX.csv',    'compare_ior_1to4',    ['ior_hard%', 'RP_2GX', 'RP_2GX', args.base_commit, args.commit]],
            ['ior_hard_c16_RP_2GX.csv',     'compare_ior_c16',     ['ior_hard%', 'RP_2GX', 'RP_2GX', args.base_commit, args.commit]],
            ['mdtest_easy_1to4_RP_2G1.csv', 'compare_mdtest_1to4', ['mdtest_easy%', 'RP_2G1', 'RP_2G1', args.base_commit, args.commit]],
            ['mdtest_easy_c16_RP_2G1.csv',  'compare_mdtest_c16',  ['mdtest_easy%', 'RP_2G1', 'RP_2G1', args.base_commit, args.commit]],
            ['mdtest_hard_1to4_RP_2G1.csv', 'compare_mdtest_1to4', ['mdtest_hard%', 'RP_2G1', 'RP_2G1', args.base_commit, args.commit]],
            ['mdtest_hard_c16_RP_2G1.csv',  'compare_mdtest_c16',  ['mdtest_hard%', 'RP_2G1', 'RP_2G1', args.base_commit, args.commit]],

            ['ior_easy_1to4_RP_3GX.csv',    'compare_ior_1to4',    ['ior_easy%', 'RP_3GX', 'RP_3GX', args.base_commit, args.commit]],
            ['ior_easy_c16_RP_3GX.csv',     'compare_ior_c16',     ['ior_easy%', 'RP_3GX', 'RP_3GX', args.base_commit, args.commit]],
            ['ior_hard_1to4_RP_3GX.csv',    'compare_ior_1to4',    ['ior_hard%', 'RP_3GX', 'RP_3GX', args.base_commit, args.commit]],
            ['ior_hard_c16_RP_3GX.csv',     'compare_ior_c16',     ['ior_hard%', 'RP_3GX', 'RP_3GX', args.base_commit, args.commit]],
            ['mdtest_easy_1to4_RP_3G1.csv', 'compare_mdtest_1to4', ['mdtest_easy%', 'RP_3G1', 'RP_3G1', args.base_commit, args.commit]],
            ['mdtest_easy_c16_RP_3G1.csv',  'compare_mdtest_c16',  ['mdtest_easy%', 'RP_3G1', 'RP_3G1', args.base_commit, args.commit]],
            ['mdtest_hard_1to4_RP_3G1.csv', 'compare_mdtest_1to4', ['mdtest_hard%', 'RP_3G1', 'RP_3G1', args.base_commit, args.commit]],
    ...
    if 's_ec' in reports:
        ...
        for rf in rfs:
            calls += [
                [f'ior_easy_s_vs_EC_%P{rf}GX',    'compare_ior_s_ec',    ['ior_easy%', f'EC_%P{rf}GX', args.base_commit, args.commit]],
                [f'ior_hard_s_vs_EC_%P{rf}GX',    'compare_ior_s_ec',    ['ior_hard%', f'EC_%P{rf}GX', args.base_commit, args.commit]],
                [f'mdtest_easy_s_vs_EC_%P{rf}G1',    'compare_mdtest_s_ec',    ['mdtest_easy%', f'EC_%P{rf}G1', args.base_commit, args.commit]],
