...
sbatch -N 4 -n 4 -p normal tests.sh SELF_TEST 2 1 16
sbatch -N 6 -n 6 -p normal tests.sh SELF_TEST 4 1 16
sbatch -N 10 -n 10 -p normal tests.sh SELF_TEST 8 1 16
sbatch -N 18 -n 18 -p normal tests.sh SELF_TEST 16 1 16
sbatch -N 34 -n 34 -p normal tests.sh SELF_TEST 32 1 16
sbatch -N 66 -n 66 -p normal tests.sh SELF_TEST 64 1 16
sbatch -N 130 -n 130 -p normal tests.sh SELF_TEST 128 1 16 
sbatch -N 258 -n 258 -p normal tests.sh SELF_TEST 256 1 16
sbatch -N 514 -n 514 -p large tests.sh SELF_TEST 512 1 16

export TESTCASE=run_st_1tomany_cli2srv_inf1
export LOGS=$BASE_DIR/WEEKLY_RESULTS/$(date +%Y%m%d)/$TESTCASE
mkdir -p $LOGS

sbatch -N 4 -n 4 -p normal tests.sh SELF_TEST 2 1 1
sbatch -N 6 -n 6 -p normal tests.sh SELF_TEST 4 1 1
sbatch -N 10 -n 10 -p normal tests.sh SELF_TEST 8 1 1
sbatch -N 18 -n 18 -p normal tests.sh SELF_TEST 16 1 1
sbatch -N 34 -n 34 -p normal tests.sh SELF_TEST 32 1 1
sbatch -N 66 -n 66 -p normal tests.sh SELF_TEST 64 1 1
sbatch -N 130 -n 130 -p normal tests.sh SELF_TEST 128 1 1
sbatch -N 258 -n 258 -p normal tests.sh SELF_TEST 256 1 1
sbatch -N 514 -n 514 -p large tests.sh SELF_TEST 512 1 1
